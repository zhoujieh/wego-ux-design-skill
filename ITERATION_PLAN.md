...
- [ ] **4.1.7** 创建 `design-library/components/toast.json` — ⚠️ 待样式优化
- [ ] **4.1.8** 创建 `design-library/components/loading.json` — ⚠️ 待样式优化
- [ ] **4.1.9** 创建 `design-library/components/input.json` — ⚠️ 待样式优化
- [ ] **4.1.10** 创建 `design-library/components/form.json` — ⚠️ 待样式优化
- [ ] **4.1.11** 创建 `design-library/components/tag.json` — ⚠️ 待样式优化
- [ ] **4.1.12** 创建 `design-library/components/cell.json` — ⚠️ 待样式优化
- [ ] **4.1.13** 创建 `design-library/components/result.json` — ⚠️ 待样式优化

> **⚠️ 注意**：4.1.5, 4.1.7~4.1.13 共 10 个组件需先完成样式优化（硬编码清理、Token 对齐）后再编写 JSON 契约。actionsheet、navbar、tabs 组件已完成优化，可作为模板参照。
