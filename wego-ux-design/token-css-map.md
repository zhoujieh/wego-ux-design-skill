...
:root {
  /* Color */
  --wg-checkbox-accent: var(--wg-color-action-primary-default);
  --wg-checkbox-accent-disabled: var(--wg-color-action-primary-disabled);
  --wg-radio-accent: var(--wg-color-action-primary-default);
  --wg-radio-accent-disabled: var(--wg-color-action-primary-disabled);
  ...
  --wg-color-bg-inverse-subtle: rgba(255, 255, 255, 0.15);
  --wg-color-bg-muted: var(--wg-color-base-neutral-100);
  --wg-color-bg-page: var(--wg-color-base-neutral-300);
  --wg-color-bg-secondary: var(--wg-color-base-neutral-100);
  ...
  --wg-color-bg-skeleton: var(--wg-color-bg-muted);
  --wg-color-bg-surface: var(--wg-color-base-static-white);
  --wg-color-bg-toast: var(--wg-color-feedback-toast-bg);
  ...
  --wg-color-border-loading-indicator: var(--wg-color-base-brand-500);
  --wg-color-border-loading-track: var(--wg-color-base-neutral-alpha-08);
  ...
  --wg-color-transparent: transparent;
  ...
  --wg-color-text-inverse-secondary: rgba(255, 255, 255, 0.70);
  --wg-color-text-inverse-weak: rgba(255, 255, 255, 0.50);
  ...
  --wg-component-actionsheet-home-indicator-height: 5px;
  --wg-component-actionsheet-home-indicator-width: 134px;
  --wg-component-actionsheet-safearea-bottom: 34px;
  --wg-component-dialog-button-height: var(--wg-size-48);
  --wg-component-dialog-closed-scale: 0.9;
  --wg-component-dialog-padding-block: var(--wg-spacing-24);
  --wg-component-dialog-padding-inline: 20px;
  --wg-component-dialog-title-only-padding-block: var(--wg-spacing-32);
  --wg-component-dialog-width: 300px;
  --wg-component-result-icon-size-large: 120px;
  --wg-component-tag-min-width-20: 36px;
  --wg-component-tag-min-width-24: var(--wg-size-40);
  --wg-component-tag-min-width-28: var(--wg-size-48);
  --wg-component-tag-min-width-32: 52px;
  --wg-component-toast-max-width: 320px;
  --wg-cell-divider-end: var(--wg-spacing-0);
  --wg-cell-divider-start: var(--wg-spacing-16);
  --wg-cell-slot-avatar: var(--wg-spacing-0);
  --wg-cell-slot-indent: var(--wg-spacing-0);
  --wg-cell-slot-select: var(--wg-spacing-0);
  --wg-size-10: 10px;
  --wg-size-12: 12px;
  --wg-size-16: 16px;
  --wg-size-20: 20px;
  ...
  --wg-layout-page-max-width: var(--wg-layout-screen-430);
